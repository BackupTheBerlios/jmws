 ...
 * +---------------------------------------------------------------------------+
 * | UserLogInRemote - Defines the SessionBean Remote interface                |
 * |                   for the User logging in operation.                      |
 * +---------------------------------------------------------------------------+
...
public interface UserLogInRemote extends EJBObject {
	...
	public Boolean checkLogIn(
		...
		String password
			...
			UserInactiveException, RemoteException;
